...
For example, the latitude and longitude CRS used by GPS is EPSG:4326. (WGS84 - World Geodetic System 1984).
A commonly used CRS for mE and mN covering the UK is EPSG:32629 (WGS 84 / UTM zone 29N).
...
This is a copy of the original csv, with the reprojected coordinates appended.
